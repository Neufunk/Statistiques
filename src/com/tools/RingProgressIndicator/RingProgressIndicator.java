 ...
 */
package tools.RingProgressIndicator;
...
public class RingProgressIndicator extends ProgressCircleIndicator {
    public RingProgressIndicator() {
        this.getStylesheets().add(RingProgressIndicator.class.getResource("/ui/CSS/RingProgress.css").toExternalForm());
    ...
    final DoubleProperty ringWidthProperty() {
        return ringWidth;
    }

    final double getRingWidth() {
