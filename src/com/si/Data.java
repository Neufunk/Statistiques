...
public class Data {
    ...
    public static final String pageTitle0 = "Soins Infirmiers - Répartition annuelle - v" + Version.versionNumber;
    ...
    public static final String pageTitle6 = "Soins Infirmiers - Répartition par âge - v" + Version.versionNumber;
}
